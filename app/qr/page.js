      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-lg text-center mb-8">
          ...
          <p className="text-purple-700 mb-6 text-lg">
            Scan these QR codes to send your support directly. Your generosity
            helps us create more amazing content!
          </p>
        ...
        <div className="bg-gradient-to-r from-yellow-300 to-pink-300 p-6 rounded-2xl shadow-lg text-center mb-8">
          ...
          >
            <a
              href="https://docs.google.com/document/d/1Uwy3ZJ2BZZBMFengo9Yq1Zp4-vMgzL6EXgN15R0JkEw/edit?tab=t.0"
              target="_blank"
